# Generated by Django 3.0.5 on 2020-05-12 21:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='EstadoCli',
            fields=[
                ('id_estado_cli', models.FloatField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='EstadoEmpleado',
            fields=[
                ('id_estado_emp', models.FloatField(primary_key=True, serialize=False)),
                ('descripcion', models.CharField(max_length=20)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='EstadoVenta',
            fields=[
                ('id_estado_venta', models.FloatField(primary_key=True, serialize=False)),
                ('descripcion', models.CharField(max_length=20)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id_fam_prod', models.BigAutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_vencimiento', models.BigIntegerField()),
        ...
        migrations.CreateModel(
            name='RespaldoVenta',
            fields=[
                ('id_respaldo', models.BigAutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='TipoEmpleado',
            fields=[
                ('id_tipo_empleado', models.BigAutoField(primary_key=True, serialize=False)),
                ('descripcion', models.CharField(max_length=20)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='TipoProducto',
            fields=[
                ('id_tipo_producto', models.BigAutoField(primary_key=True, serialize=False)),
                ('descripcion', models.CharField(max_length=200)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='TipoVivienda',
            fields=[
                ('id_tipo_vivienda', models.BigAutoField(primary_key=True, serialize=False)),
                ('descripcion', models.CharField(max_length=20)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='UsuarioCliente',
            fields=[
                ('id_usuario_cliente', models.BigAutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id_usuario_empleado', models.BigAutoField(primary_key=True, serialize=False)),
                ('usuario', models.CharField(max_length=20)),
